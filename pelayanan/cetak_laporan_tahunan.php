...
<?php
    ...
    if (isset($_POST['cetak_tahun'])) {
        include('config.php');
        $tahun = $_POST['tahun'];
        $query = "SELECT * FROM history_plang_imb WHERE year(ttgl_imb) = '$tahun'";
        $hasil_query = mysqli_query($koneksi, $query);
        $no = 1;
    echo "<h3><center>Laporan IMB Selesai Periode Tahun $tahun<center></h3>";
